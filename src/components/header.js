...
const Header = ({ siteTitle }) => (
  <header className="header">
      ...
      <ul className="links">
        <li><a className="facebook" href="https://www.facebook.com/thebikestationbudapest/" tagret="_blank">
        ...
        <li><a className="messenger" href="https://www.messenger.com/t/thebikestationbudapest" tagret="_blank">
